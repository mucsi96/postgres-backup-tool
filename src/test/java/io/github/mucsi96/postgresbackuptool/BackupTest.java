...
public class BackupTest extends BaseIntegrationTest {
  ...
  public void shows_number_of_backups() {
    WebElement backupsHeadingBefore = webDriver
  ...
  public void shows_backups() {
    ...
    assertThat(table.getText().split("\\s+")).isEqualTo(
        new String[] { "Date", "Name", "Records", "Size", "Retention", "Action",
            "1", "minute", "ago", "20230629-124243.9.1.pgdump", "9", "0.0", "B",
            "1", "day", "Restore", "1", "minute", "ago",
            "20230629-124242.3.7.pgdump", "3", "0.0", "B", "7", "days",
            "Restore", "1", "minute", "ago", "20230629-124241.1.30.pgdump", "1",
            "0.0", "B", "30", "days", "Restore" });
  }
}
